...
const plans: Plan[] = [
  ...
  },
  {
    ...
    features: [
      "1 seat",
      "Full MCP, all 52 tools, the built-in agent",
      "Radar: 25 standing item scans",
      "Deep shopping browser sessions",
                ...
                >
                  <Card
                    className={cn(
                      ...
                      plan.popular && "border-primary shadow-lg shadow-[0_8px_40px_-8px_rgba(37,99,235,0.35)]",
                    )}
                  >
                    {plan.popular && (
                      <>
